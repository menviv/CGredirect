<%
' For example: transaction_id = 183828b3-e573-478f-a311-e4a88d5b89c2
if VarType(Request.QueryString("txId")) then
	transaction_id = Request.QueryString("txId")
	RANDOMIZE
	...
	xmlDoc.async = False
	Response.write("Result Code: "&xmlDoc.getElementsByTagName("result").item(1).Text)
	Response.write("<br />Unique ID: "&xmlDoc.getElementsByTagName("uniqueid").item(0).Text)
	Response.write("<br />Language Code: "&xmlDoc.getElementsByTagName("languageCode").item(0).Text)
	Response.write("<br />Auth Number: "&xmlDoc.getElementsByTagName("authNumber").item(0).Text)
	Response.write("<br />Card Token: "&xmlDoc.getElementsByTagName("cardId").item(0).Text)
	Response.write("<br />Card Expiration: "&xmlDoc.getElementsByTagName("cardExpiration").item(0).Text)
	Response.write("<br />Card Mask: "&xmlDoc.getElementsByTagName("cardMask").item(0).Text)
	Response.write("<br />Personal ID: "&xmlDoc.getElementsByTagName("personalId").item(0).Text)
	Response.write("<br />Transaction ID: "&xmlDoc.getElementsByTagName("mpiTransactionId").item(0).Text)
else
	Response.write("transaction ID is missing")
end if
